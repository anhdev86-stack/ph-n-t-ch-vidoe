      ...
      <Header className="bg-white px-4 flex justify-between items-center shadow-sm sticky top-0 z-10 w-full" style={{ backgroundColor: '#ffffff', padding: '0 16px' }}>
        <div className="flex items-center">
          ...
          <img
            src="/logo-mark.png"
            alt="INFI TECH"
            style={{ height: 32, width: "auto", marginRight: 10 }}
          />
          <span className="text-base font-semibold" style={{ letterSpacing: 0.3 }}>
            Infi Tech <span style={{ color: "#B8912F" }}>- Affiliate</span>
          </span>
        </div>
